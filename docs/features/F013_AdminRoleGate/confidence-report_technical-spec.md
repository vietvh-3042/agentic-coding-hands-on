---
source_artifact: docs/features/F013_AdminRoleGate/technical-spec.md
claims_total: 2
...
# Confidence Report -- docs/features/F013_AdminRoleGate/technical-spec.md
...
| ----------------- | -------------------- | ----------------------------------------------------------------------- | ---------- |
| (unlabeled claim) | 3. Actions           | components/homepage/user-menu.tsx:95-99                                 | ○          |
| ·                 | 4. Shared Foundation | supabase/migrations/20260906190000_profiles_column_privileges.sql:53-57 | ○          |
