      ...
      <main className="flex w-full max-w-3xl flex-1 flex-col items-center justify-between bg-white px-16 py-32 sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          <h1 className="max-w-xs text-3xl leading-10 font-semibold tracking-tight text-black">
            ...
            <code className="rounded bg-black/6 px-1.5 py-0.5 font-mono text-[0.9em]">page.tsx</code> file.
          </h1>
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          ...
          >
            <Image className="h-3.5 w-4 dark:invert" src="/vercel.svg" alt="Vercel logomark" width={16} height={14} />
            Deploy Now
          </a>
          <a
            className="flex h-12 w-full items-center justify-center rounded-full border border-solid border-black/8 px-5 transition-colors hover:border-transparent hover:bg-black/4 md:w-39.5 dark:hover:bg-[#1a1a1a]"
