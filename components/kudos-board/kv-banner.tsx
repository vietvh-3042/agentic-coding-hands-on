 ...
 * Renders behind the fixed `SiteHeader` (own `pt-[184px]` = 80px header +
...
export default function KvBanner() {
  ...
  return (
    ...
    <section className="relative h-128 w-full overflow-hidden bg-[#00101A]" aria-label={t("kudosBoard:kvBanner.title")}>
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-288 flex-col items-start gap-[10px] px-6 pt-46 lg:px-0">
        ...
        <img
          ...
          className="h-auto w-[70vw] max-w-[593px]"
        />
      </div>
    </section>
  );
