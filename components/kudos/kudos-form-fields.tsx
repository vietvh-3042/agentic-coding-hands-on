  ...
  return (
    <>
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-4">
          ...
          <KudosRecipientSelect
            ...
            onSelect={(recipient) => onChange((prev) => ({ ...prev, recipient }))}
          />
        </div>
      ...
      <KudosTitleInput
        ...
        onChange={(kudoTitle) => onChange((prev) => ({ ...prev, kudoTitle }))}
      />
      ...
      <div className="flex w-full flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex gap-4">
            ...
            <KudosHashtagInput
              ...
              onChange={(hashtagIds) => onChange((prev) => ({ ...prev, hashtagIds }))}
            />
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <KudosImageUpload images={form.images} onChange={(images) => onChange((prev) => ({ ...prev, images }))} />
        </div>
      </div>
          ...
          <input
            ...
            onChange={(event) =>
              onChange((prev) => ({
                ...
                anonymousName: event.target.checked ? prev.anonymousName : "",
              }))
            }
