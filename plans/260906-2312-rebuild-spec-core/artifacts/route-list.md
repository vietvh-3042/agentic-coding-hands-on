...
**Summary**: 6 App Router pages (`page.tsx`), 5 of which are guarded by the proxy (`/countdown`, `/about`, `/award-info`, `/sun-kudos`, and `/` which itself only redirects to the 6th, unguarded `/login`).
