...
import { starTier } from "@/lib/kudos/hashtags";
import type { KudoCardData, KudoPersonBlock } from "@/lib/kudos/types";
...
function mapKudoRow(
  ...
  return {
    ...
    starTier: starTier(starTiersByReceiver.get(receiver.id) ?? 0),
  };
}
