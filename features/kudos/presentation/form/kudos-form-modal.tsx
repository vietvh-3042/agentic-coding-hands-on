...
import { submitKudoAction } from "@/features/kudos/application/actions/submit-kudo";
...
export interface KudosFormModalProps {
   ...
   *  itself). Required, not optional: hashtag is a required field, so a
   *  caller that omits the list ships a form that can never be submitted.
   *  It was optional once and three call sites silently defaulted to `[]`. */
  hashtags: Hashtag[];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`${montserrat.className} relative flex max-h-[90vh] w-full max-w-188 flex-col gap-8 overflow-y-auto rounded-3xl bg-[#FFF8E1] p-10 shadow-2xl transition-all duration-300 ${
