...
import { DEPARTMENTS, departmentLabel, type DepartmentOption } from "@/features/kudos/domain/departments";
...
export default function HighlightSection({ hashtags, kudos }: HighlightSectionProps) {
  ...
  const hashtagOptions: DepartmentOption[] = hashtags.map((h) => ({ value: h.id, label: `#${h.name}` }));
